...
public class NotificationTool {
    ...
    public String sendNotification(
            @ToolParam(description = "Resumo completo da conversa realizada com o paciente") 
            String resumoConversa,
            
            @ToolParam(description = "Principal dúvida ou questionamento apresentado pelo paciente") 
            String duvidaCliente,
            
            @ToolParam(description = "Nível de interesse do paciente no procedimento ou consulta (alto, médio, baixo)") 
            String interesse,
            
            @ToolParam(description = "Valor estimado do procedimento ou consulta, ou 'A negociar' se não definido") 
            String valor,
            
            @ToolParam(description = "Tipo de notificação a ser enviada (urgente, normal, informativa)") 
